...
var Fullcalendar = (function () {
    ...
    DatatableAjax = (function () {
        ...
        if (typeof $.fn.dataTable !== "undefined") {
            ...
            var form_filter = $('form#form-datatale-filter');
                ...
                form_filter.each(function(){
                    $(this).on('submit',function(event){
                        ...
                        var new_action = $(this).serializeArray().reduce(function (obj, item) {
                            ...
                            return updateQueryStringParameter(t.ajax.url(),item.name,item.value);
                        }, "");
...
function FormExecute(forms) {
    ...
    e.length && e.each(function () {
        ...
        channel.bind(cons, ({data})=>{
           ...
           $(cons).animate({ scrollTop: $(cons).prop("scrollHeight")}, "fast");
        });
       $(this).on("submit",function(event){
           event.preventDefault();
           $(cons+">code").html("");
