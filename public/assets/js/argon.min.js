        ...
        if (typeof $.fn.dataTable !== "undefined") {
            ...
            $.each(ajaxTableData.getThead(),(i,th)=>{
                ...
                if(th.type == "checkbox"){
                    ...
                    column.render = function ( data, type, row ) {
                            return '<a href="'+indexSplitSign(row,th.link)+'">'+row[th.key]+'</a>';
                    }
                ...
                if(th.join){
                    if(th.key){
                        ...
                        column.render = function ( data, type, row ) {
                            ...
                            var lastword = ct.lastIndexOf(th.join);
                            ct = ct.substring(0, lastword);
                            return ct;
                        }
                    }
                            ...
                            return $.ajax({
                                ...
                                success: response => {
                                    if (response.success) {
                                        ...
                                        card.set({
                                            frame_front: response.data.front,
