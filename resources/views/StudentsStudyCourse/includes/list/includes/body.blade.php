                ...
                <div class="d-none" id="datatable-ajax-option">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                            ...
                            <a href="#" data-toggle="modal" data-target="#modal" id="btn-option-photo"
                                class="dropdown-item">
                                <i class="fas fa-portrait "></i>
                                {{Translator::phrase("photo")}}
                            </a>
                            <a href="#" data-toggle="modal" data-target="#modal" id="btn-option-qrcode"
                                class="dropdown-item">
                                <i class="fas fa-qrcode "></i>
                                {{Translator::phrase("qrcode")}}
                            </a>
                            <a href="#" data-toggle="modal" data-target="#modal" id="btn-option-card"
                                class="dropdown-item">
