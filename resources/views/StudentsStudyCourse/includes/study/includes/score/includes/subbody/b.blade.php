<tbody class="list">
    @if ($response["success"])
    @include(config("pages.parent").".includes.study.includes.score.includes.subbody.c")
    @else
    <tr class="text-center">
        <td colspan="{{ DateHelper::daysOfMonth(request("year"),request("month")) + 6 }}" scope="rowgroup">
            <p class="m-0">
