<div class="card-body p-0" >
    <div class="row">
        <div class="{{count($listData) <= 1 ? "col-md-12":"col-md-8"}}" data-list-group>
            @if (config("pages.parameters.param1") == "account")
            ...
            <div class="card sticky-top">
                ...
                <div class="card-body p-2">
                    <div class="list-group list-group-flush">
                        ...
                        <a href="{{$list["action"][config("pages.parameters.param1") == "account"? "account" : config("pages.form.role")]}}" data-toggle="list-group"
