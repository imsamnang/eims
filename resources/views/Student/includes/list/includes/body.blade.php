            ...
            <thead class="thead-light">
                <tr>
                    ...
                    <th data-type="text" data-key="id" width="1" class="sort" data-sort="id">
                        {{__("Id")}}​</th>
                    <th data-type="modal" data-key="name" data-url="action.view" class="sort" data-sort="name">
                        {{__("Name")}}​</th>
        ...
        <div class="d-none" id="datatable-ajax-option">
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                    ...
                    <a data-toggle="modal-ajax" data-target="#modal" id="btn-option-account" class="dropdown-item"
                        href="">
