                    ...
                    <aside class="lg-side">
                        ...
                        <div class="inbox-body">
                            <div class="mail-option">
                                ...
                                <div class="btn-group">
                                    <a href="#"
                                        data-href="{{str_replace("add","mark-read",config("pages.form.action.add"))}}"
                                        class="btn btn-danger disabled" data-toggle="sweet-alert"
                                        data-sweet-alert="confirm" sweet-alert-controls-id="" data-checked-show="read">
                                        <i class="fas fa-book-reader m-0"></i>
                                ...
                                <div class="btn-group">
                                    <a href="#"
                                        data-href="{{str_replace("add","mark-important",config("pages.form.action.add"))}}"
                                        class="btn btn-danger disabled" data-toggle="sweet-alert"
                                        data-sweet-alert="confirm" sweet-alert-controls-id=""
                                        data-checked-show="important">
                                        <i class="fas fa-bookmark m-0"></i>
                                        <span class="d-none d-sm-inline">
                                            {{Translator::phrase("mark_important")}}
                                        </span>
                                    </a>
                                </div>
                                <div class="btn-group">
                            ...
                            <table class="table table-inbox table-hover">
                                <tbody>
                                    ...
                                    <tr class="{{$row["read_or_unread"]}}">
                                        ...
                                        <td class="view-message  dont-show">{{$row["from"]["name"]}}</td>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    ...
                                                    <a data-toggle="modal" data-target="#mailbox-compose"
                                                        ...
                                                        {{Translator::phrase("mark_important")}}</a>
