<fieldset class="p-2 border text-sm">
    ...
    <table class="table">
        <tbody>
            <tr>
                <td colspan="2">{{__('Frame')}}</td>
            </tr>
            <tr>
                <td class="border" style="vertical-align: top; text-align: center;">
                    <img data-src="{{$row['foreground']}}" class="w-100">
                </td>
                <td class="border" style="vertical-align: top; text-align: center;">
                    <img data-src="{{$row['background']}}" class="w-100">
                </td>
            </tr>
        </tbody>
    </table>
