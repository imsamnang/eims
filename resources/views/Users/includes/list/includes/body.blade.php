        ...
        <table id="datatable-basic"
            ...
            <thead class="thead-light">
                <tr>
                    ...
                    <th data-type="text" data-key="name" class="sort" data-sort="name">
                        {{__("Name")}}​</th>
                    <th data-type="text" data-key="role.name">{{__("Role")}}</th>
                    <th data-type="text" data-key="email,phone" data-join="<br>">
                        {{__("Email  & Phone")}}</th>
                    <th data-type="image" data-key="profile">{{__("Image")}}</th>
                    <th data-type="option" data-key="view,edit,delete"></th>
            ...
            <tbody>
                ...
                <tr data-target="#modal" data-href="{{$row["action"]["view"]}}">
                    ...
                    <td>
                        <img src="{{$row['profile']}}" alt="" width="30">
                    </td>
