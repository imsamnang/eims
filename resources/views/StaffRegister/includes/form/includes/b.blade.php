                    ...
                    @if (config('pages.parameters.param1') == 'view')
                        ...
                        @if (config('pages.form.data.gender.id') == 1)
                            <div class="custom-control custom-radio custom-control-inline col-6">
                                <input {{ config('pages.form.data.gender.id') == 1 ? 'checked' : '' }}
                                    data-toggle="radio" type="radio" id="male" name="gender" value="1"
                        ...
                        @else
                            ...
                            <div class="custom-control custom-radio custom-control-inline col-6">
                                <input {{ config('pages.form.data.gender.id') == 2 ? 'checked' : '' }}
                                    data-toggle="radio" type="radio" id="female" name="gender" value="2"
                                    class="custom-control-input"
                                    {{ config('pages.form.validate.rules.gender') ? 'required' : '' }} />
