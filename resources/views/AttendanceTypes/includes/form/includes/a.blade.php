    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="form-row">
                    <div class="col-md-6 mb-3">
                        <label class="form-control-label" for="credit_absent">
                            {{ __('Credit absent') }}

                            @if (config('pages.form.validate.rules.credit_absent'))
                                <span class="badge badge-md badge-circle badge-floating badge-danger"
                                    style="background:unset"><i class="fas fa-asterisk fa-xs"></i></span>
                            @endif

                        </label>
                        <input type="number" class="form-control" name="credit_absent" id="credit_absent" placeholder=""
                            value="{{ config('pages.form.data.' . $key . '.credit_absent') }}"
                            {{ config('pages.form.validate.rules.credit_absent') ? 'required' : '' }} />
                    </div>
