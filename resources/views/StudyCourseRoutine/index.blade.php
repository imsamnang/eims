...
@for($i = 0 ; $i< count($keys);$i++) @php $meta=array();$content=array(); @endphp @foreach ($keys[$i] as $name=> $item)
                            ...
                            <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">
                                        {{Translator::phrase(config("pages.parameters.param1").'.study_course_routine')}}
                                    </li>
                                    @else
                                    <li class="breadcrumb-item">
                                        <a
                                            href="{{url(config("pages.host").config("pages.path").config("pages.pathview")."list")}}">
                                            {{Translator::phrase("list.study_course_routine")}}
                                        </a>
                                    </li>
                                    <li class="breadcrumb-item active" aria-current="page">
    ...
    <script src="{{asset("/assets/vendor/jquery-contextmenu/dist/jquery.contextMenu.min.js")}}"></script>
    <script src="{{asset("/assets/js/custom/course-routine.js")}}"></script>
