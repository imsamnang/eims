    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="form-row">
                    <div class="col-md-12 mb-3">
                        <label class="form-control-label" for="view_path">
                            {{ __('view_path') }}

                            @if(config("pages.form.validate.rules.view_path"))
                            <span class="badge badge-md badge-circle badge-floating badge-danger"
                                style="background:unset"><i class="fas fa-asterisk fa-xs"></i></span>
                            @endif
                        ...
                        <input type="text" class="form-control" name="view_path" id="view_path"
                            placeholder=""
                            value="{{config("pages.form.data.view_path")}}"
                            {{config("pages.form.validate.rules.view_path")? "required" : ""}} />
