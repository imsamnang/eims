            ...
            <div class="col-12 collapse mb-3 p-0 {{array_intersect(request()->all(), array_keys(['programId','courseId','generationId','yearId','semesterId'])) ? "show" : ""}}"
                ...
                <div class="col-xl-8 col-12">
                    <div class="form-row">
                        ...
                        @isset($districts)
                        <div class="col-md-6 mb-3">
                            <select {{request('districtId') ? "" : "disabled"}} class="form-control"
                        ...
                        @isset($communes)
                        <div class="col-md-6 mb-3">
                            <select {{request('communeId') ? "" : "disabled"}} class="form-control" data-toggle="select"
                                id="commune" title="Simple select"
