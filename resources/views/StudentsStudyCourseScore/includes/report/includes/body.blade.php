...
<div class="card-body py-0 {{config("pages.parameters.param1") == "report" ? "p-0" : ""}}">
    <div class="table-responsive" data-toggle="list" data-list-values='["id", "name"'>
        <table class="table w-100 table-bordered table-hover table-xs" id="t1 list-table">
            @include("StudentsStudyCourseScore.includes.report.includes.subbody.a")
            @include("StudentsStudyCourseScore.includes.report.includes.subbody.b")
        </table>
    </div>
</div>
