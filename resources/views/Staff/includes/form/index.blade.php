                            ...
                            <div class="{{count($listData) <= 1 ? "col-md-12":"col-md-10"}}" data-list-group>
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        @include("Staff.includes.form.includes.a")
                                        @endif
                                        @include("Staff.includes.form.includes.b")
                                        @include("Staff.includes.form.includes.c")
                                        @include("Staff.includes.form.includes.d")
                                    </div>
                                    <div class="col-md-6">
                                        @include("Staff.includes.form.includes.e")
                                        @include("Staff.includes.form.includes.f")
                                    </div>
                                </div>
