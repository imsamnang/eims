                    ...
                    <div style="display: inline-block;border: 1px solid #ccc;padding: 10px;">
                        ...
                        <div>
                            <label style="display: inline-block;width:100%"
                                for="designation">{{__('Designation')}}</label>
                            <select style="display: inline-block" class="form-control" data-toggle="select"
                                id="designation" title="Simple select" data-allow-clear="true"
                                data-text="{{ __("Add new option") }}" data-placeholder=""
                                data-select-value="{{request('designationId')}}" name="designationId">
                                <option value="">{{__('Choose')}}</option>
                                @foreach($designationFilter["data"] as $o)
                                <option {{$o["id"] ==request('designationId') ?'selected':''}}
