                        ...
                        <div>
                            ...
                            <select style="display: inline-block" class="form-control" data-toggle="select" id="staff"
                                ...
                                @foreach ($staffFilter['data'] as $o)
                                    <option {{ $o['id'] == request('staffId') ? 'selected' : '' }}
                        ...
                        <div>
                            ...
                            <select style="display: inline-block" class="form-control" data-toggle="select" id="quiz"
                                ...
                                @foreach ($quizFilter['data'] as $o)
                                    <option {{ $o['id'] == request('quizId') ? 'selected' : '' }}
                                        data-src="{{ $o['image'] }}" value="{{ $o['id'] }}">{{ $o['name'] }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div>
                            ...
                            <select style="display: inline-block" class="form-control" data-toggle="select"
                                ...
                                @foreach ($answerTypeFilter['data'] as $o)
                                    <option {{ $o['id'] == request('answerTypeId') ? 'selected' : '' }}
                                        data-src="{{ $o['image'] }}" value="{{ $o['id'] }}">{{ $o['name'] }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div>
                            ...
                            <select style="display: inline-block" class="form-control" data-toggle="select"
                                ...
                                @foreach ($questionTypeFilter['data'] as $o)
                                    <option {{ $o['id'] == request('questionTypeId') ? 'selected' : '' }}
                                        data-src="{{ $o['image'] }}" value="{{ $o['id'] }}">{{ $o['name'] }}</option>
                                @endforeach
                            </select>
                        </div>
