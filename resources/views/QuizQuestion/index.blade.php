                ...
                <div class="header-body">
                    <div class="row align-items-center py-4">
                        <div class="col-lg-6 col-7">
                            <h6 class="h2 text-white d-inline-block mb-0">{{Translator::phrase("quiz_question")}} </h6>
                            <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">
                                        {{Translator::phrase(config("pages.parameters.param1").'.quiz_question')}}
                                    </li>
                                    @else
                                    <li class="breadcrumb-item">
                                        <a
                                            href="{{url(config("pages.host").config("pages.path").config("pages.pathview")."list")}}">
                                            {{Translator::phrase("list.quiz_question")}}
                                        </a>
                                    </li>
                                    <li class="breadcrumb-item active" aria-current="page">
