...
<footer id="footer" class="bg-gradient1-{{config("app.theme_color.name")}} footer mt-2"    data-theme-bg-color="gradient-{{config("app.theme_color.name")}}">
<div class="container">
        <div class="row">
            <div class="col-xl-4 col-xs-6">
                <span class="text-white title">{{__("Quick links")}}</span>
            ...
            <div class="col-xl-4 col-xs-6">
                <span class="text-white title">{{__("Social media")}}</span>
                <ul class="list-unstyled quick-links">
            ...
            <div class="col-xl-4 col-xs-6">
                <span class="text-white title">{{__("ស្វែងរកតាមបណ្តាញសង្គមFacebook")}}</span>
                <ul class="list-unstyled quick-links">
                    <li>
