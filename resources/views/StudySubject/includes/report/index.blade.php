                    ...
                    <div style="display: inline-block;border: 1px solid #ccc;padding: 10px;">
                        ...
                        <div>
                            <label style="display: inline-block;width:100%"
                                for="courseType">{{__('Course Type')}}</label>
                            <select style="display: inline-block" class="form-control" data-toggle="select"
                                id="courseType" title="Simple select" data-allow-clear="true"
                                data-text="{{ __("Add new option") }}" data-placeholder=""
                                data-select-value="{{request('courseTypeId')}}" name="courseTypeId">
                                <option value="">{{__('Choose')}}</option>
                                @foreach($courseTypeFilter["data"] as $o)
                                <option {{$o["id"] ==request('courseTypeId') ?'selected':''}} data-src="{{$o["image"]}}"
                                    value="{{$o["id"]}}">{{ $o["name"]}}</option>
                                @endforeach
                            </select>
                        </div>
