                    ...
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th data-type="text" data-key="name" class="sort" data-sort="name">
                                {{Translator::phrase("language")}}​</th>
                            <th data-type="text" data-key="code_name">{{Translator::phrase("code_name")}}​</th>
                            <th data-type="text" data-key="country_code">{{Translator::phrase("country_code")}}​</th>
