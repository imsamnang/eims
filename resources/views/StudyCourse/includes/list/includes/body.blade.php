                ...
                <table data-url="{{request()->url()}}-datatable{{config("pages.search")}}" class="table table-flush"
                    ...
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th data-type="text" data-key="study_modality.name" width="1" class="sort"
                                data-sort="modality">
                                {{Translator::phrase("study_modality")}}​
                            </th>
                            <th data-type="text" data-key="study_generation.name" width="1" class="sort"
                                data-sort="generation">
