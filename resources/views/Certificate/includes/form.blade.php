<div class="form-row">
    ...
    <div class="col-md-6 mb-3">
        ...
        <span class="form-control" id="id" name="id" value="{{config("pages.form.data.id")}}">{{config("pages.form.data.id")}}</span>
    </div>
    @endif
</div>
        ...
        <div class="form-group">
            <div class="input-group">
                ...
                <select class="form-control" data-toggle="select" id="institute" title="Simple select"
                    data-minimum-results-for-search="Infinity" data-placeholder="{{ Translator::phrase("institute") }}"
                    name="institute" data-select-value="{{config("pages.form.data.institute.id")}}"
        ...
        <div class="form-group">
            <div class="input-group">
                ...
                <select class="form-control" data-toggle="select"
                    id="type" title="Simple select" data-minimum-results-for-search="Infinity"
    ...
    <div class="col-md-6 mb-3">
        ...
        <div class="form-group">
            <div class="input-group">
                ...
                <input class="form-control" id="name" placeholder="{{ Translator::phrase("name") }}" name="name"
    ...
    <div class="col-md-6 mb-3">
        ...
        <div class="form-group">
            <div class="input-group">
                ...
                <select class="form-control" data-change-text="frame_front,frame_background" data-toggle="select"
                    id="layout" title="Simple select" data-minimum-results-for-search="Infinity"
...
<div class="form-row">
        ...
        <div class="dropzone dropzone-single" data-toggle="dropzone"
            ...
            <div class="dz-preview dz-preview-single">
                <div class="dz-preview-cover">
                    <img class="dz-preview-img" data-src="{{config("pages.form.data.front")}}" alt data-dz-thumbnail>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-6">
        ...
        <div class="dropzone dropzone-single" data-toggle="dropzone"
            ...
            <div class="dz-preview dz-preview-single">
                <div class="dz-preview-cover">
                    <img class="dz-preview-img" data-src="{{config("pages.form.data.background")}}" alt
                        data-dz-thumbnail>
                </div>
            </div>
        </div>
...
<div class="form-row">
    <div class="col-md-12">
        <label data-toggle="tooltip" rel="tooltip" data-placement="top"
            title="{{(array_key_exists("extra_info",config("pages.form.validate.questions"))) ?config("pages.form.validate.questions")["extra_info"] : ""}}"
            class="form-control-label " for="extra_info">
        ...
        <div class="form-group">
            <div class="input-group">
                ...
                <textarea type="text" class="form-control" name="extra_info" id="extra_info"
                    placeholder="{{ Translator::phrase("extra_info") }}"
                    {{(array_key_exists("extra_info", config("pages.form.validate.rules"))) ? "required" : ""}}>{{config("pages.form.data.extra_info")}}</textarea>
            </div>
        </div>
    </div>
</div>
