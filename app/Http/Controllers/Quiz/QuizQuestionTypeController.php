...
class QuizQuestionTypeController extends Controller
{
    ...
    public function index($param1 = 'list', $param2 = null, $param3 = null)
    {
        ...
        $pages['form']['validate'] = [
            'rules'       =>  FormQuizQuestionType::rules(),
            'attributes'  =>  FormQuizQuestionType::attributes(),
            'messages'    =>  FormQuizQuestionType::messages(),
            'questions'   =>  FormQuizQuestionType::questions(),
        ];
        //Select Option
