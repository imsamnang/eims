...
class StudentsStudyCourseController extends Controller
{
    ...
    public function index($param1 = 'list', $param2 = null, $param3 = null)
    {
        ...
        $pages['form']['validate'] = [
            'rules'       => ($param1 == 'account') ? ['password' => 'required'] :  FormStudentsStudyCourse::rulesField(),
            'attributes'  => ($param1 == 'account') ? ['password' => __('Password')] :  FormStudentsStudyCourse::attributeField(),
            'messages'    => ($param1 == 'account') ? [] :  FormStudentsStudyCourse::customMessages(),
            'questions'   => ($param1 == 'account') ? [] :  FormStudentsStudyCourse::questionField(),
        ];
