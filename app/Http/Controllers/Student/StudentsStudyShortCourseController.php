...
class StudentsStudyShortCourseController extends Controller
{
    ...
    public function index($param1 = 'list', $param2 = null, $param3 = null)
    {
        ...
        $pages['form']['validate'] = [
            'rules'       => ($param1 == 'account') ? ['password' => 'required'] :  FormStudentsStudyShortCourse::rulesField(),
            'attributes'  => ($param1 == 'account') ? ['password' => __('Password')] :  FormStudentsStudyShortCourse::attributeField(),
            'messages'    => ($param1 == 'account') ? [] :  FormStudentsStudyShortCourse::customMessages(),
            'questions'   => ($param1 == 'account') ? [] :  FormStudentsStudyShortCourse::questionField(),
        ];
