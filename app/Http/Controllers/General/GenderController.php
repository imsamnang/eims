...
class GenderController extends Controller
{
    ...
    public function index($param1 = 'list', $param2 = null, $param3 = null)
    {
        ...
        $pages['form']['validate'] = [
            'rules'       =>  FormGender::rulesField(),
            'attributes'  =>  FormGender::attributeField(),
            'messages'    =>  FormGender::customMessages(),
            'questions'   =>  FormGender::questionField(),
        ];
    ...
    public function add($data)
    {
        ...
        $data['title']     = Translator::phrase(Users::role(app()->getLocale()) . '. | .add.gender');
    ...
    public function edit($data, $id)
    {
        ...
        $data['view']       = Gender::$path['view'] . '.includes.form.index';
        $data['title']      = Translator::phrase(Users::role(app()->getLocale()) . '. | .edit.gender');
        $data['metaImage']  = asset('assets/img/icons/register.png');
    ...
    public function view($data, $id)
    {
        $response = Gender::getData($id, true);
        $data['view']       = Gender::$path['view'] . '.includes.form.index';
        $data['title']      = Translator::phrase(Users::role(app()->getLocale()) . '. | .view.gender');
        $data['metaImage']  = asset('assets/img/icons/register.png');
