...
class StudyModalityController extends Controller
{
    ...
    public function index($param1 = 'list', $param2 = null, $param3 = null)
    {
        ...
        if ($param1 == 'list') {
            if (strtolower(request()->server('CONTENT_TYPE')) == 'application/json') {
                return StudyModality::getData(null, null, 10);
            } else {
                $data = $this->list($data);
            }
        } elseif (strtolower($param1) == 'list-datatable') {
            if (strtolower(request()->server('CONTENT_TYPE')) == 'application/json') {
                return  StudyModality::getDataTable();
            } else {
                $data = $this->list($data);
            }
        } elseif ($param1 == 'add') {
        ...
        $pages['form']['validate'] = [
            'rules'       =>  FormStudyModality::rulesField(),
            'attributes'  =>  FormStudyModality::attributeField(),
            'messages'    =>  FormStudyModality::customMessages(),
            'questions'   =>  FormStudyModality::questionField(),
        ];
        //Select Option
