...
class StudyGenerationsController extends Controller
{
    ...
    public function index($param1 = 'list', $param2 = null, $param3 = null)
    {
        $breadcrumb  = [
            [
                'title' => __('Study'),
                'status' => 'active',
                'link'  => url(Users::role() . '/study/' . StudyGeneration::path('url')),
            ],
            [
                'title' => __('List Study Generation'),
                'status' => false,
        ...
        if ($param1 == null || $param1 == 'list') {
            ...
            $breadcrumb[]  = [
                'title' => __($param1),
                'status' => 'active',
                'link'  => url(Users::role() . '/study/' . StudyGeneration::path('url') . '/' . $param1),
            ];
            ...
            $breadcrumb[]  = [
                'title' => __($param1),
                'status' => 'active',
                'link'  => url(Users::role() . '/study/' . StudyGeneration::path('url') . '/' . $param1 . '/' . $id),
            ];
            if (request()->method() === 'POST') {
            ...
            $data = $this->show($data, $id, $param1);
            $data['view']  = StudyGeneration::path('view') . '.includes.view.index';
    ...
    public function show($data, $id, $type)
    {
        ...
        $data['title'] = Users::role(app()->getLocale()) . ' | ' . __('Study Generation') . ' | ' . __($type);
        return $data;
    }
