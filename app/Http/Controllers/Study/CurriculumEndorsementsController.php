...
class CurriculumEndorsementsController extends Controller
{
    ...
    public function index($param1 = 'list', $param2 = null, $param3 = null)
    {
        $breadcrumb  = [
            [
                'title' => __('Study'),
                'status' => 'active',
                'link'  => url(Users::role() . '/study/' . CurriculumEndorsement::path('url')),
            ],
            [
                'title' => __('Curriculum Endorsements'),
                'status' => false,
        ...
        if ($param1 == null || $param1 == 'list') {
            ...
            $breadcrumb[]  = [
                'title' => __($param1),
                'status' => 'active',
                'link'  => url(Users::role() . '/study/' . CurriculumEndorsement::path('url') . '/' . $param1),
            ];
            ...
            $breadcrumb[]  = [
                'title' => __($param1),
                'status' => 'active',
                'link'  => url(Users::role() . '/study/' . CurriculumEndorsement::path('url') . '/' . $param1 . '/' . $id),
            ];
            if (request()->method() === 'POST') {
            ...
            $data = $this->show($data, $id, $param1);
            $data['view']  = CurriculumEndorsement::path('view') . '.includes.view.index';
    ...
    public function list($data, $id = null)
    {
        ...
        $response = $table->get()->map(function ($row, $nid) use ($count) {
            ...
            $row->image = ImageHelper::site(CurriculumEndorsement::path('image'), $row->image);
            $row->action  = [
        ...
        $data['title']    = Users::role(app()->getLocale()) . ' | ' . __('Curriculum Endorsements');
        return $data;
    }
    ...
    public function show($data, $id, $type)
    {
        ...
        $data['title'] = Users::role(app()->getLocale()) . ' | ' . __('Curriculum Endorsements') . ' | ' . __($type);
        return $data;
    }
    ...
    public function report()
    {
        ...
        config()->set('app.title', __('Curriculum Endorsements'));
        ...
        config()->set('pages.title', __('Curriculum Endorsements'));
