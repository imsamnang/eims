...
class AttendanceTypeController extends Controller
{
    ...
    public function index($param1 = 'list', $param2 = null, $param3 = null)
    {
        ...
        if ($param1 == 'list') {
            if (strtolower(request()->server('CONTENT_TYPE')) == 'application/json') {
                return AttendancesType::getData(null, null, 10);
            } else {
                $data = $this->list($data);
            }
            ...
            return AttendancesType::deleteFromTable($id);
        ...
        $data['instituteFilter']['data']           = Institute::whereIn('id', AttendancesType::groupBy('institute_id')->pluck('institute_id'))
    ...
    public function report()
    {
        ...
        config()->set('pages.parent', AttendancesType::$path['view']);
        ...
        config()->set('pages.title', __('List Attendance'));
        return view(AttendancesType::$path['view'] . '.includes.report.index', $data);
    }
}
