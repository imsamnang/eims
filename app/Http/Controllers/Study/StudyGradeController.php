...
class StudyGradeController extends Controller
{
    ...
    public function index($param1 = 'list', $param2 = null, $param3 = null)
    {
        ...
        if ($param1 == 'list') {
            if (strtolower(request()->server('CONTENT_TYPE')) == 'application/json') {
                return  StudyGrade::getData(null, null, 10,request('search'));
            } else {
                $data = $this->list($data);
            }
        ...
        $pages['form']['validate'] = [
            'rules'       =>  FormStudyGrade::rulesField(),
            'attributes'  =>  FormStudyGrade::attributeField(),
            'messages'    =>  FormStudyGrade::customMessages(),
            'questions'   =>  FormStudyGrade::questionField(),
        ];
    ...
    {
        $data['response'] =  StudyGrade::getData(null, null, 10);
    ...
    {
        $response = StudyGrade::getData($id, true);
        $data['view']       = StudyGrade::$path['view'] . '.includes.form.index';
