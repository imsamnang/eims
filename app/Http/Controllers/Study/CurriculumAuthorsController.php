...
class CurriculumAuthorsController extends Controller
{
    ...
    public function index($param1 = 'list', $param2 = null, $param3 = null)
    {
        $breadcrumb  = [
            [
                'title' => __('Study'),
                'status' => 'active',
                'link'  => url(Users::role() . '/study/' . CurriculumAuthor::path('url')),
            ],
            [
                'title' => __('List Curriculum Authors'),
                'status' => false,
        ...
        if ($param1 == null || $param1 == 'list') {
            ...
            $breadcrumb[]  = [
                'title' => __($param1),
                'status' => 'active',
                'link'  => url(Users::role() . '/study/' . CurriculumAuthor::path('url') . '/' . $param1),
            ];
            ...
            $breadcrumb[]  = [
                'title' => __($param1),
                'status' => 'active',
                'link'  => url(Users::role() . '/study/' . CurriculumAuthor::path('url') . '/' . $param1 . '/' . $id),
            ];
            if (request()->method() === 'POST') {
            ...
            $data = $this->show($data, $id, $param1);
            $data['view']  = CurriculumAuthor::path('view') . '.includes.view.index';
    ...
    public function list($data, $id = null)
    {
        ...
        $data['title']    = Users::role(app()->getLocale()) . ' | ' . __('List Curriculum Authors');
        return $data;
    }
    ...
    public function show($data, $id, $type)
    {
        ...
        $data['title'] = Users::role(app()->getLocale()) . ' | ' . __('Curriculum Authors') . ' | ' . __($type);
        return $data;
    }
    ...
    public function report()
    {
        ...
        config()->set('app.title', __('List Curriculum Authors'));
        ...
        config()->set('pages.title', __('List Curriculum Authors'));
