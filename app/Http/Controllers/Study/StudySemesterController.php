...
class StudySemesterController extends Controller
{
    ...
    public function add($data)
    {
        ...
        $data['title']     = Translator::phrase(Users::role(app()->getLocale()) . '. | .add.Study_Semester');
    ...
    public function edit($data, $id)
    {
        ...
        $data['view']       = StudySemesters::$path['view'] . '.includes.form.index';
        $data['title']      = Translator::phrase(Users::role(app()->getLocale()) . '. | .edit.Study_Semester');
        $data['metaImage']  = asset('assets/img/icons/register.png');
    ...
    public function view($data, $id)
    {
        $response = StudySemesters::getData($id, true);
        $data['view']       = StudySemesters::$path['view'] . '.includes.form.index';
        $data['title']      = Translator::phrase(Users::role(app()->getLocale()) . '. | .view.Study_Semester');
        $data['metaImage']  = asset('assets/img/icons/register.png');
