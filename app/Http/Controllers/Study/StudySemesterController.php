...
use App\Http\Requests\FormStudySemesters;
...
class StudySemesterController extends Controller
{
    ...
    public function index($param1 = 'list', $param2 = null, $param3 = null)
    {
        ...
        if ($param1 == 'list') {
            if (strtolower(request()->server('CONTENT_TYPE')) == 'application/json') {
                return  StudySemesters::getData(null, null, 10,request('search'));
            } else {
                $data = $this->list($data);
            }
        ...
        $pages['form']['validate'] = [
            'rules'       =>  FormStudySemesters::rulesField(),
            'attributes'  =>  FormStudySemesters::attributeField(),
            'messages'    =>  FormStudySemesters::customMessages(),
            'questions'   =>  FormStudySemesters::questionField(),
        ];
    ...
    public function list($data)
    {
        ...
        $data['title'] = Users::role(app()->getLocale()).'|'.__('List Study Semesters');
        return $data;
    }
    ...
    public function add($data)
    {
        ...
        $data['title'] = Users::role(app()->getLocale()).'|'.__('Add Study Semesters');
    ...
    {
        $response = StudySemesters::getData($id, true);
        $data['view']       = StudySemesters::$path['view'] . '.includes.form.index';
        $data['title'] = Users::role(app()->getLocale()).'|'.__('Edit Study Semesters');
        $data['metaImage']  = asset('assets/img/icons/register.png');
    ...
    public function view($data, $id)
    {
        $response = StudySemesters::getData($id, true);
        $data['view']       = StudySemesters::$path['view'] . '.includes.form.index';
        $data['title'] = Users::role(app()->getLocale()).'|'.__('View Study Semesters');
        $data['metaImage']  = asset('assets/img/icons/register.png');
