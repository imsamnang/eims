...
class StudyFacultiesController extends Controller
{
    ...
    public function index($param1 = 'list', $param2 = null, $param3 = null)
    {
        $breadcrumb  = [
            [
                'title' => __('Study'),
                'status' => 'active',
                'link'  => url(Users::role() . '/study/' . StudyFaculty::path('url')),
            ],
            [
                'title' => __('List Study Faculty'),
                'status' => false,
        ...
        if ($param1 == null || $param1 == 'list') {
            ...
            $breadcrumb[]  = [
                'title' => __($param1),
                'status' => 'active',
                'link'  => url(Users::role() . '/study/' . StudyFaculty::path('url') . '/' . $param1),
            ];
            ...
            $breadcrumb[]  = [
                'title' => __($param1),
                'status' => 'active',
                'link'  => url(Users::role() . '/study/' . StudyFaculty::path('url') . '/' . $param1 . '/' . $id),
            ];
            if (request()->method() === 'POST') {
            ...
            $data = $this->show($data, $id, $param1);
            $data['view']  = StudyFaculty::path('view') . '.includes.view.index';
    ...
    public function list($data, $id = null)
    {
        ...
        $response = $table->get()->map(function ($row, $nid) use ($count) {
            ...
            $row->image = ImageHelper::site(StudyFaculty::path('image'), $row->image);
            $row->action  = [
    ...
    public function show($data, $id, $type)
    {
        ...
        $data['title'] = Users::role(app()->getLocale()) . ' | ' . __('Study Faculty') . ' | ' . __($type);
        return $data;
    }
