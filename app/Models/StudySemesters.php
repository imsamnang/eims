...
class StudySemesters extends Model
{
    ...
    public static function getData($id = null, $edit = null, $paginate = null, $search = null)
    {
        ...
        $get = StudySemesters::orderBy('id', $orderBy);
    ...
    public static function addToTable()
    {
        ...
        if ($validator->fails()) {
            ...
            try {
                ...
                $add = StudySemesters::insertGetId($values);
    ...
    public static function updateToTable($id)
    {
        ...
        if ($validator->fails()) {
            ...
            try {
                ...
                $update = StudySemesters::where('id', $id)->update($values);
                if ($update) {
                    if (request()->hasFile('image')) {
                        $image      = request()->file('image');
    ...
    public static function updateImageToTable($id, $image)
    {
        ...
        if ($image) {
            try {
                $update =  StudySemesters::where('id', $id)->update([
                    'image'    => $image,
                ]);
    ...
    public static function deleteFromTable($id)
    {
        if ($id) {
            $id  = explode(',', $id);
            if (StudySemesters::whereIn('id', $id)->get()->toArray()) {
