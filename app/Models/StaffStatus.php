...
class StaffStatus extends Model
{
    ...
    public static function getData($id = null, $edit = null, $paginate = null)
    {
        $pages['form'] = array(
            'action'  => array(
                'add'    => url(Users::role() . '/' . Staff::$path['url'] . '/' . StaffStatus::$path['url'] . '/add/'),
            ),
        );
        ...
        $get = StaffStatus::orderBy('id', $orderBy);
            ...
            try {
                ...
                if ($add) {
                    ...
                    if (request()->hasFile('image')) {
                        ...
                        ImageHelper::uploadImage(false, StaffStatus::$path['image'], StaffStatus::$path['image'], public_path('/assets/img/icons/image.jpg'));
                    }

                    $response       = array(
                        'success'   => true,
                        'type'      => 'add',
                        'data'      => StaffStatus::getData($add)['data'],
                        'message'   => array(
