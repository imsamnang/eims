...
class Nationality extends Model
{
    ...
    public static function getData($id = null, $edit = null, $paginate = null, $search = null)
    {
        ...
        $get = Nationality::orderBy('id', $orderBy);
    ...
    public static function addToTable()
    {
        ...
        if ($validator->fails()) {
            ...
            try {
                ...
                $add = Nationality::insertGetId($values);
                if ($add) {
                    ...
                    $response       = array(
                        'success'   => true,
                        'type'      => 'add',
                        'data'      => Nationality::getData($add)['data'],
                        'message'   => array(
                            'title' => __('Success'),
    ...
    public static function updateToTable($id)
    {
        ...
        if ($validator->fails()) {
            ...
            try {
                ...
                $update = Nationality::where('id', $id)->update($values);
                if ($update) {
                    if (request()->hasFile('image')) {
                        $image      = request()->file('image');
    ...
    public static function updateImageToTable($id, $image)
    {
        ...
        if ($image) {
            try {
                $update =  Nationality::where('id', $id)->update([
                    'image'    => $image,
                ]);
    ...
    public static function deleteFromTable($id)
    {
        if ($id) {
            $id  = explode(',', $id);
            if (Nationality::whereIn('id', $id)->get()->toArray()) {
