...
class CurriculumEndorsement extends Model
{
    ...
    public static function getData($id = null, $edit = null, $paginate = null, $search = null)
    {
        ...
        if ($id) {
            ...
            $get = CurriculumEndorsement::orderBy('id', $orderBy);
        } else {
            $get = CurriculumEndorsement::orderBy('id', 'DESC');
        }
    ...
    {
        $model = CurriculumEndorsement::query();
    ...
    public static function addToTable()
    {
        ...
        if ($validator->fails()) {
            ...
            try {
                ...
                $add = CurriculumEndorsement::insertGetId($values);
                if ($add) {
    ...
    public static function updateToTable($id)
    {
        ...
        if ($validator->fails()) {
            ...
            try {
                ...
                $update = CurriculumEndorsement::where('id', $id)->update($values);
                if ($update) {
                    if (request()->hasFile('image')) {
                        $image      = request()->file('image');
    ...
    public static function updateImageToTable($id, $image)
    {
        ...
        if ($image) {
            try {
                $update =  CurriculumEndorsement::where('id', $id)->update([
                    'image'    => $image,
                ]);
    ...
    public static function deleteFromTable($id)
    {
        if ($id) {
            $id  = explode(',', $id);
            if (CurriculumEndorsement::whereIn('id', $id)->get()->toArray()) {
