...
class MotherTong extends Model
{
    ...
    public static function getData($id = null, $edit = null, $paginate = null, $search = null)
    {
        ...
        $get = MotherTong::orderBy('id', $orderBy);
    ...
    public static function addToTable()
    {
        ...
        if ($validator->fails()) {
            ...
            try {
                ...
                $add = MotherTong::insertGetId($values);
                if ($add) {
                    ...
                    $response       = array(
                        'success'   => true,
                        'type'      => 'add',
                        'data'      => MotherTong::getData($add)['data'],
    ...
    public static function updateToTable($id)
    {
        ...
        if ($validator->fails()) {
            ...
            try {
                ...
                $update = MotherTong::where('id', $id)->update($values);
                if ($update) {
                    if (request()->hasFile('image')) {
                        $image      = request()->file('image');
    ...
    public static function updateImageToTable($id, $image)
    {
        ...
        if ($image) {
            try {
                $update =  MotherTong::where('id', $id)->update([
                    'image'    => $image,
                ]);
    ...
    public static function deleteFromTable($id)
    {
        if ($id) {
            $id  = explode(',', $id);
            if (MotherTong::whereIn('id', $id)->get()->toArray()) {
