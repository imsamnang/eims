...
class CurriculumAuthor extends Model
{
    ...
    public static function getData($id = null, $edit = null, $paginate = null, $search = null)
    {
        ...
        $get = CurriculumAuthor::orderBy('id', $orderBy);
    ...
    public static function addToTable()
    {
        ...
        if ($validator->fails()) {
            ...
            try {
                ...
                $add = CurriculumAuthor::insertGetId($values);
                if ($add) {
                    ...
                    $response       = array(
                        'success'   => true,
                        'type'      => 'add',
                        'data'      => CurriculumAuthor::getData($add),
    ...
    public static function updateToTable($id)
    {
        ...
        if ($validator->fails()) {
            ...
            try {
                ...
                $update = CurriculumAuthor::where('id', $id)->update($values);
                if ($update) {
                    if (request()->hasFile('image')) {
                        $image      = request()->file('image');
                    ...
                    $response       = array(
                        'success'   => true,
                        'type'      => 'update',
                        'data'      => CurriculumAuthor::getData($id),
    ...
    public static function updateImageToTable($id, $image)
    {
        ...
        if ($image) {
            try {
                $update =  CurriculumAuthor::where('id', $id)->update([
                    'image'    => $image,
                ]);
    ...
    public static function deleteFromTable($id)
    {
        if ($id) {
            $id  = explode(',', $id);
            if (CurriculumAuthor::whereIn('id', $id)->get()->toArray()) {
